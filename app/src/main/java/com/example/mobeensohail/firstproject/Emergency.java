...
//Extract the data…
        //String etphone = bundle.getString("etphone");
        ...
        sentPI = PendingIntent.getBroadcast(Emergency.this, 0, new Intent(SENT), 0);
        deliveredPI = PendingIntent.getBroadcast(Emergency.this, 0, new Intent(DELIVERED), 0);
